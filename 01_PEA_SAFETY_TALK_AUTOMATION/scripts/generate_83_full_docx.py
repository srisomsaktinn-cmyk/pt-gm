...
DOCX_OUT = r'd:\Kaeha\แบบฟอร์มกิจกรรม PEA safety talk [Cybersecurity]_พร้อมรายชื่อ_ครบถ้วน83คน.docx'
...
def parse_and_insert():
    ...
    # New person to insert as Sequence 31
    new_person = {
        'emp_id': '504811',
    ...
    # Insert at index 30 (Sequence 31)
    participants.insert(30, new_person)

    # Re-assign sequences 1 to 83
...
def process():
    participants = parse_and_insert()
    print(f"Total participants (including กฟต.1): {len(participants)}")
    ...
    print(f"Successfully updated 83-person docx: {DOCX_OUT}")
