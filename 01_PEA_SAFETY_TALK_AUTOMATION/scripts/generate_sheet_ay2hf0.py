...
MD_PATH = r'd:\Kaeha\tableConvert.com_ay2hf0.md'
DOCX_IN = r'd:\Kaeha\แบบฟอร์มกิจกรรม PEA safety talk [Cybersecurity].docx'
DOCX_OUT = r'd:\Kaeha\แบบฟอร์มกิจกรรม PEA safety talk [Cybersecurity]_การประชุมวันที่27สค2569_16คน.docx'
...
def process():
    ...
    print(f"Parsed {len(participants)} participants directly from Markdown tableConvert.com_ay2hf0.md!")
    ...
    print(f"Successfully generated docx from MD: {DOCX_OUT}")
