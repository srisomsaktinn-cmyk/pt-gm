...
DOCX_OUT = r'd:\Kaeha\แบบฟอร์มกิจกรรม PEA safety talk [Cybersecurity]_พร้อมรายชื่อ_3x9z2h_อัปเดต83คน.docx'
...
def process():
    ...
    print(f"Total participants after insertion: {len(participants)}")
    ...
    print(f"Successfully updated docx: {DOCX_OUT}")
