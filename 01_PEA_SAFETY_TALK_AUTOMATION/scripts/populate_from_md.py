...
MD_PATH = r'd:\Kaeha\tableConvert.com_mws72c.md'
DOCX_IN = r'd:\Kaeha\แบบฟอร์มกิจกรรม PEA safety talk [Cybersecurity].docx'
DOCX_OUT = r'd:\Kaeha\แบบฟอร์มกิจกรรม PEA safety talk [Cybersecurity]_พร้อมรายชื่อ_ถูกต้อง100เปอร์เซ็นต์.docx'
...
def process():
    ...
    print(f"Parsed {len(participants)} participants directly from Markdown!")
