...
DOCX_OUT = r'd:\Kaeha\แบบฟอร์มกิจกรรม PEA safety talk [Cybersecurity]_การประชุมครั้งใหม่_ถูกต้อง100เปอร์เซ็นต์.docx'
...
def process():
    ...
    print(f"Parsed {len(participants)} participants directly from Markdown tableConvert.com_a2vtui.md!")
