...
### 4.3 Run Monte Carlo Permutation Analysis (10,000 Iterations)
```bash
python rsi_trend_pullback/run_monte_carlo.py
```

### 4.4 Launch Automated MetaTrader 5 Paper Trading Bot
1. Open your MetaTrader 5 terminal and log into your **Demo/Paper account**.
2. Ensure the **Algo Trading** button is enabled (green) in the MT5 toolbar.
3. Launch the bot:
```bash
...
Every live paper trade automatically logs to `output_paper_trading/xauusd_v26_shadow_audit_log.csv` tracking:
